...
Каждый может скопировать этот Git-репозиторий себе на компьютер и через несколько минут иметь собственную BIM-библиотеку на GitHub pages. Ее можно использовать для библиотеки BIM-компонентов предприятия, конструкторского бюро или производителя оборудования, в т.ч. для хранения компонентов для других программных комплексов.
