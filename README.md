...
Файл *.gitignore* устанавливает правила для синхронизации файлов с GitHub. Здесь важно, что внутри папки *components* разрешена синхронизация только файлов *\*.zip* (в глубине каталога 4) и *md5*. То есть, "распакованные" репозитории не появляются в GitHub. Это сделано по соображениям производительности.
