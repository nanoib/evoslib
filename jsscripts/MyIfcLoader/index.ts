...
import { SpatialStructure } from "./src/spatial-structure.ts";
import { CivilReader, IfcFragmentSettings, IfcMetadataReader } from "./src/index.ts";
import { FragmentsManager } from "../FragmentsManager/index.ts";
import { Component, Components, Event, Disposable } from "../../core/index.ts";
import { IfcJsonExporter } from "../../ifc/IfcJsonExporter/index.ts";
import { SpatialIdsFinder } from "./src/spatial-ids-finder.ts";

export * from "./src/ifc-fragment-settings.ts";
...
export class IfcLoader extends Component implements Disposable {
   ...
   */
  static readonly uuid = "e9c0f00f-064e-4577-871a-4f247f56aaf4" as const;
